  ...
  passages: [
    {
      ...
      prompt: "In your letter, you should: \n1. Say where you went. \n2. Describe what you did there. \n3. Explain why you enjoyed it."
    },
    {
      id: 2,
      type: "Hard (Task 2)",
      ...
      prompt: "Consider the following: \n1. How AI helps students learn faster. \n2. The risks of students becoming too dependent on technology. \n3. Give your own opinion on the balance."
    }
  ]
},
  ...
  passages: [
    {
      ...
      questions: [
        "Can you describe the town or city where you live?",
    ...
    },
    {
      ...
      instruction: "Describe a journey you remember well. You should say: where you went, how you travelled, who you went with, and explain why it was memorable.",
      preparationTime: 60, // sekund
      speakingTime: 120    // sekund
    }
  ]
}
